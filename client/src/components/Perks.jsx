    ...
    return (
        <div className='text-gray-500 text-sm mt-4 grid gap-3 grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="kitchen" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="wifi" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="tv" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="washer" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="airConditioning" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="hairDryer" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="petsAllowed" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="freePark" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="iron" onChange={handleChecked} />
            ...
            <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                <input type="checkbox" name="securityCameras" onChange={handleChecked} />
